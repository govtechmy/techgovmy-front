      ...
      <div className="w-full border-otl-divider border-x justify-center">
        ...
        <div className="mx-auto max-w-5xl p-6">
          ...
          <div className="flex flex-col gap-[24px] my-6">
            <h2 className="font-semibold text-heading-md text-txt-black-900">{aboutUs?.["intro-header"]}</h2>
          ...
          {/* Our Values */}
          <h3 className="mb-2 text-heading-md font-semibold text-txt-black-900">{t('our_values')}</h3>
            ...
            {aboutUs["our-values"].map((value: {[key: string]: string}, index: number) => (
              <div key={index} className="p-6 border border-gray-200 rounded-lg shadow-sm flex flex-row gap-4">
                ...
                <div className="flex-1">
                  <h3 className="mb-2 text-heading-xs font-semibold text-txt-black-900">{value?.["card-header"]}</h3>
          ...
          <section className="max-w-6xl mx-auto px-4 pt-8 text-left">
            <h2 className="text-heading-md font-semibold mb-2 text-txt-black-900">{t('our_community')}</h2>
          </section>
...
const KadKommuniti=async({community_text}: { community_text: string })=>{
    ...
    return <div className="flex flex-col items-center">
        ...
        />
        <div
            className="mt-4 inline-flex items-center text-txt-black-900 font-medium text-heading-xs"
        >
          {community_text}
